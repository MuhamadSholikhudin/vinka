                    ...
                    <div class='col-sm-10'>
                        ...
                        <select class='form-control' name='id_siswa' id='inputid_siswa'>
                           ...
                           foreach($siswa as  $row) {
                            ?>
                                <option value='<?= $row['id_siswa'] ?>'><?= $row['id_siswa'] ?></option><?php
                            }
                            ?>
                        </select>                        
                    </div>
                    ...
                    <div class='col-sm-10'>
                        ...
                        <select class='form-control' name='id_kelas' id='inputid_kelas'>
                           ...
                           foreach($kelas as  $row) {
                            ?>
                                <option value='<?= $row['id_kelas'] ?>'><?= $row['id_kelas'] ?></option><?php
                            }
                            ?>
                        </select>                        
                    </div>
                    ...
                    <div class='col-sm-10'>
                        ...
                        <select class='form-control' name='id_mapel' id='inputid_mapel'>
                           ...
                           foreach($mapel as  $row) {
                            ?>
                                <option value='<?= $row['id_mapel'] ?>'><?= $row['id_mapel'] ?></option><?php
                            }
                            ?>
                        </select>                        
                    </div>
                    ...
                    <div class='col-sm-10'>
                        ...
                        <select class='form-control' name='id_periode' id='inputid_periode'>
                           ...
                           foreach($periode as  $row) {
                            ?>
                                <option value='<?= $row['id_periode'] ?>'><?= $row['id_periode'] ?></option><?php
                            }
                            ?>
                        </select>                        
                    </div>
