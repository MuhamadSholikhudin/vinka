        ...
        <form action='<?= $url ?>/aksi/siswa.php' method='post' enctype='multipart/form-data' class='form-horizontal'>
          <div class='box-body'>
                ...
                <div class='form-group' >
                    ...
                    <div class='col-sm-10'>
                        <input type='number' class='form-control' id='inputid_user' name='id_user' value='<?= $siswa['id_user']; ?>'  required>
                    </div>
                  </div>
                <div class='form-group' >
                ...
                <div class='form-group' >
                    ...
                    <div class='col-sm-10'>
                        <input type='file' class='form-control' id='inputfoto_siswa' name='foto_siswa' value='<?= $siswa['foto_siswa']; ?>'  required>
                    </div>
                  </div>
           </div>
