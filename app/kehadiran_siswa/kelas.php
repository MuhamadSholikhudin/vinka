                ...
                <table class="table">
                    ...
                    <body>
                        ...
                        <tr>
                            ...
                            <td><?= $row['nm_mapel'] ?></td>
                            <td>
                                <a href='<?= $url ?>/app/kehadiran_siswa/siswa.php?id_periode=<?= $_GET['id_periode'] ?>&id_kelas=<?= $_GET['id_kelas'] ?>&id_mapel=<?=  $row['id_mapel'] ?>' class='btn btn-primary btn-sm '>
                                    <i class='fa fa-arrow-right'></i> Siswa
                                </a>
                            </td>
                        </tr>
                        <?php 
