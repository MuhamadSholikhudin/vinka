                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <?php
                                $check_catatan_wali_kelas = "SELECT * FROM rapot WHERE id_periode = " . $_GET['id_periode'] . " AND id_siswa = " . $_GET['id_siswa'] . " AND jenis = 'ektrakulikuler' ";
                                if (QueryOnedata($check_catatan_wali_kelas)->num_rows > 0) { // Jika ada maka update data
                                ?>
                                    <td>1</td>
                                    <td><?= QueryOnedata($check_catatan_wali_kelas)->fetch_assoc()['pengetahuan'] ?></td>
                                    <td><?= QueryOnedata($check_catatan_wali_kelas)->fetch_assoc()['value'] ?></td>
                                    <td><?= QueryOnedata($check_catatan_wali_kelas)->fetch_assoc()['deskripsi'] ?></td>
